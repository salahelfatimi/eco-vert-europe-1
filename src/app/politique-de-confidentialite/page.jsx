...
export const metadata = {
  ...
  openGraph: {
    title: "Eco Vert Europé | Politique de Confidentialité",
    description:"Eco Vert Europé, le service de réparation fiable en Moselle, France, est votre expert pour les interventions d'urgence. Avec une équipe de vitriers, serruriers, plombiers et électriciens qualifiés, Eco Vert Europé vous garantit une disponibilité 24h/24 et 7j/7 pour les réparations urgentes. Qu'il s'agisse d'une vitre cassée, d'une serrure bloquée, d'un problème de plomberie ou d'une panne électrique, leur équipe de professionnels est prête à résoudre vos problèmes rapidement et efficacement.",
    url: `${process.env.NEXT_PUBLIC_BASE_URL}/politique-de-confidentialite`,
    robots: {
      index: true,
      follow: true,
    },
    siteName: "Eco Vert Europé | Politique de Confidentialité",
    images: [
      {
...
export default function PolitiqueConfidentialite() {
  return (
    <>
      <div className="bg-white container pt-20">
        <div
          className={` font-panchang p-6 text-secondary lg:text-base text-xs md:text-sm text-justify container`}
        >
          ...
          <p className="mb-4">
            Chez <span className="font-semibold text-primary">Eco Vert Europé</span>, nous
          ...
          <p className="mb-4">
            ...
            <a
              href="mailto:eco.vert.europe@gmail.com"
              className="text-blue-600 hover:underline"
            >
              eco.vert.europe@gmail.com
            </a>
          </p>
