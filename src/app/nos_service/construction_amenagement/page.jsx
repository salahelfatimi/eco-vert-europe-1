...
export function generateMetadata() {
  return {
    ...
    openGraph: {
      ...
      siteName: "Eco Vert Europé | Construction & Aménagement",
      images: [
        {
          ...
          width: 1200,
          height: 675,
          alt: "Eco Vert Europé | Construction & Aménagement - Projets Clés en Main",
        },
      ],
      type: "website",
    },
...
export default function ConstructionAmenagementService() {
  return (
      ...
      <div className="">
        ...
        <div className="relative h-screen min-w-full w-full">
          ...
          <Image
            width={1920}
            height={1080}
            src="/img/service/construction.jpg" // Replace with your construction and development image
            alt="Construction & Aménagement – Projets Clés en Main"
          ...
          >
            <h1 className="font-black text-2xl md:text-6xl text-white text-center font-panchang-bold">
              Construction & Aménagement - Projets Sur Mesure
            </h1>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto overflow-hidden">
          <div className="p-6">
            <p className="text-secondary mb-4 font-panchang">
              Chez Eco Vert Europé, nous proposons des services complets de construction et d’aménagement pour des projets résidentiels, commerciaux et industriels. De la conception à la réalisation, nous vous accompagnons à chaque étape pour garantir des résultats de haute qualité.
            </p>

            <h2 className="text-2xl font-semibold text-primary mb-4 font-panchang-bold">
              Nos Services en Construction & Aménagement
            </h2>
            <ul className="list-disc list-inside font-panchang text-secondary mb-6">
              <li>Construction de maisons individuelles et collectives</li>
              <li>Aménagement de bureaux et espaces commerciaux</li>
              <li>Rénovation et extension de bâtiments</li>
              <li>Construction de bâtiments industriels et entrepôts</li>
              <li>Aménagement intérieur et extérieur</li>
              <li>Gestion de projet clé en main</li>
              <li>Conseils en design et architecture</li>
            </ul>
