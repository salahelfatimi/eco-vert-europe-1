    ...
    return (
      <>
        {isVisible && (
            ...
            <div className="container flex flex-col items-center lg:items-start mx-auto  bg-secondary rounded-lg shadow-lg p-6"> 
              <p className=" font-bold  text-center ">cookies consentement</p>
              <p className="text-xs text-center mb-4"> Ce site utilise des cookies pour améliorer votre expérience. Consultez notre{" "} <Link href="/politique-de-confidentialite" className="text-primary underline hover:text-primary" > politique de confidentialité </Link> . </p>
