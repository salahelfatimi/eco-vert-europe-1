    ...
    return (
        <div className="relative py-20 overflow-hidden">
            ...
            <div className="container relative z-10">
                <h2 className="font-panchang-bold font-medium text-xl uppercase text-white  lg:text-4xl text-center mb-12">
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="font-panchang text-primary font-medium ">Étude & Conception</h3>
                            </div>
                            <p className="font-panchang text-sm text-gray-300 mt-2">
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="font-panchang text-primary font-medium ">Sélection des Matériaux & Équipements</h3>
                            </div>
                            <p className="font-panchang text-sm text-gray-300 mt-2">
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="font-panchang font-medium  text-primary">Visualisation & Planification</h3>
                            </div>
                            <p className="font-panchang text-sm text-gray-300 mt-2">
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="font-panchang text-primary font-medium ">Travaux d’Installation & Réfection</h3>
                            </div>
                            <ul className="font-panchang text-sm text-gray-300 list-disc pl-10 mt-2">
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="font-panchang text-primary font-medium ">Suivi & Coordination</h3>
                            </div>
                            <p className="font-panchang text-sm text-gray-300 mt-2">
