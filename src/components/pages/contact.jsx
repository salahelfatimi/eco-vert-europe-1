            ...
            <div className=" container w-full flex-col xl:flex-row  gap-16 flex p-8  justify-between items-center ">         
                <form onSubmit={sendEmail} className="flex flex-col gap-4   w-full ">
                        ...
                        <div className={`flex flex-col gap-4 w-full ${ etaps == 2 ?'block':'hidden'}`}>
                            ...
                            <div className=" flex flex-col gap-2 w-full">
                                <input  value={formData.budget} onChange={handleInputChange} type="number" name="budget" id="budget" placeholder="Budget" className={`  placeholder:font-medium capitalize  px-4 h-14 rounded  font-panchang  border-primary border-2 bg-white [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`} />
                            </div>
                            <div className=" flex flex-col gap-2 w-full">
                        ...
                        <div className=" w-full flex flex-col md:flex-row gap-4">
                            <button onClick={()=>(handeleNext('retour'))} type="button" className= {`  w-full rounded-full bg-primary py-4 hover:text-primary hover:bg-white border-2 border-primary duration-500 font-medium text-white `}> Retour </button>
                            <button onClick={()=>(handeleNext('suivante'))} type="button" className= {` ${etaps==3 ? 'hidden':'block'} w-full rounded-full bg-primary py-4 hover:text-primary hover:bg-white border-2 border-primary duration-500 font-medium text-white `}> Suivante </button>
